        ...
        {!sidebarCollapsed && (
          <div className="px-3 py-3 relative">
            ...
            >
              ...
              <ChevronDown className={cn('w-4 h-4 text-gray-400 transition-transform', showWorkspaceSwitcher && 'rotate-180')} />
            </button>
            ...
            <AnimatePresence>
              {showWorkspaceSwitcher && workspaces.length > 1 && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -4 }}
                  className="absolute top-full left-3 right-3 mt-1 bg-gray-800 rounded-lg shadow-lg border border-gray-700 py-1 z-50"
                >
                  {workspaces.map((ws) => (
                    <button
                      key={ws._id}
                      ...
                      className={cn(
                        ...
                        currentWorkspace?._id === ws._id && 'bg-gray-700'
                      )}
                    >
                      <div
                ...
                {projectsExpanded && (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-gray-500 hover:text-white hover:bg-gray-800 transition-colors"
                    >
